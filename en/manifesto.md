# The Journalist Experience Manifesto

Journalist Experience (JX): a narrative for the future of digital newsrooms.
...
## Principles of Journalist Experience

### 1. A journalist’s focus matters more than tool complexity.

Tools should protect attention instead of scattering it across unnecessary steps, screens, and decisions.

### 2. Human narrative matters more than mass content production.

The newsroom’s systems should help people explain meaning, context, and consequence—not merely increase output volume.

### 3. Human-AI collaboration matters more than replacing people with technology.

AI should strengthen editorial judgment, reduce repetitive labor, and keep responsibility visible.

### 4. Reducing information chaos matters more than adding more features.

Better JX favors clarity, prioritization, and usable signals over endless capabilities.

### 5. Calmer newsrooms produce more accurate media.

Sustainable rhythms and coherent workflows are editorial infrastructure, not workplace luxuries.

### 6. Publishing speed must not replace accuracy and trust.

Fast publication is valuable only when verification, context, and accountability remain intact.

### 7. Media tools must fit the realities of online newsrooms, not old patterns.

Systems should be lightweight, flexible, reliable, and designed for today’s connected editorial work.

### 8. Social networks are part of journalism’s environment, not just distribution channels.

Discovery, reaction, crisis, and audience understanding now happen inside networked spaces.

### 9. Journalist Experience directly affects journalistic quality.

The conditions of work shape concentration, judgment, accuracy, and the final story the public receives.

### 10. The future of media depends on the relationship between people, technology, and information flows.

Technology alone will not determine journalism’s future; the quality of this relationship will.
