# منشور تجربه روزنامه‌نگار

تجربه روزنامه‌نگار (JX)؛ روایتی برای آینده تحریریه‌های دیجیتال.

> تجربه بهتر برای روزنامه‌نگار، آینده بهتر برای روزنامه‌نگاری.
...
ما باور داریم زمان آن رسیده است که «تجربه روزنامه‌نگار» به‌عنوان یکی از مسائل بنیادین آینده رسانه‌ها شناخته شود.

«تجربه روزنامه‌نگار» یا Journalist Experience مفهومی است که به کیفیت تجربه انسانی، ذهنی و عملیاتی افراد درگیر در کار تحریریه، از خبرنگار و دبیر تا عکاس خبری، تهیه‌کننده و روزنامه‌نگار داده، در فرایند تولید، ویرایش، انتشار و تحلیل محتوا می‌پردازد. این مفهوم صرفاً درباره طراحی رابط کاربری یا ساخت نرم‌افزارهای زیباتر نیست. مسئله اصلی، کیفیت کار و زیستن روزنامه‌نگار در محیط رسانه‌ای امروز است؛ محیطی که سرعت، فشار اطلاعات، چندوظیفگی و ارتباط دائمی به بخشی جدایی‌ناپذیر از آن تبدیل شده‌اند.
...
«تجربه روزنامه‌نگار» فقط یک موضوع فناورانه نیست. این مفهوم به سلامت حرفه‌ای و ذهنی روزنامه‌نگاران نیز مربوط می‌شود. فرسودگی شغلی، آشفتگی ذهنی، کاهش تمرکز و فشار دائمی انتشار، بخشی از واقعیت امروز بسیاری از تحریریه‌هاست. رسانه‌ای که نتواند محیط کاری سالم‌تر، آرام‌تر و منسجم‌تری برای روزنامه‌نگاران خود ایجاد کند، در بلندمدت نه‌تنها کیفیت محتوای خود را از دست می‌دهد، بلکه سرمایه انسانی و اعتماد عمومی را نیز فرسوده می‌کند.
...
## اصول تجربه روزنامه‌نگار

### 1. تمرکز روزنامه‌نگار مهم‌تر از پیچیدگی ابزارهاست.

ابزارها باید توجه روزنامه‌نگار را حفظ کنند، نه اینکه آن را میان گام‌ها، صفحه‌ها و تصمیم‌های غیرضروری پراکنده کنند.

### 2. روایت انسانی مهم‌تر از تولید انبوه محتواست.

سامانه‌های تحریریه باید به انسان برای توضیح معنا، زمینه و پیامد کمک کنند، نه فقط حجم خروجی را بالا ببرند.

### 3. همکاری انسان و هوش مصنوعی مهم‌تر از جایگزینی انسان با فناوری است.

هوش مصنوعی باید قضاوت تحریریه را تقویت کند، کار تکراری را کاهش دهد و مسئولیت انسانی را قابل مشاهده نگه دارد.

### 4. کاهش آشفتگی اطلاعات مهم‌تر از افزودن قابلیت‌های بیشتر است.

تجربه روزنامه‌نگار خوب، شفافیت، اولویت‌بندی و نشانه‌های قابل استفاده را بر قابلیت‌های بی‌پایان ترجیح می‌دهد.

### 5. تحریریه‌های آرام، رسانه‌های دقیق‌تری می‌سازند.

ریتم پایدار و گردش‌کار منسجم، زیرساخت تحریریه‌ای است؛ نه امتیازی لوکس برای محیط کار.

### 6. سرعت انتشار نباید جایگزین دقت و اعتماد شود.

انتشار سریع زمانی ارزشمند است که راستی‌آزمایی، زمینه و پاسخ‌گویی همچنان حفظ شوند.

### 7. ابزارهای رسانه باید با واقعیت تحریریه‌های آنلاین سازگار باشند، نه با الگوهای قدیمی.

سامانه‌ها باید سبک، انعطاف‌پذیر، قابل اعتماد و متناسب با کار تحریریه‌ای متصل امروز طراحی شوند.

### 8. شبکه‌های اجتماعی بخشی از محیط روزنامه‌نگاری‌اند، نه فقط کانال توزیع محتوا.

کشف خبر، واکنش مخاطب، بحران و فهم جامعه اکنون در فضاهای شبکه‌محور نیز شکل می‌گیرند.

### 9. تجربه روزنامه‌نگار مستقیماً بر کیفیت روزنامه‌نگاری اثر می‌گذارد.

شرایط کار، تمرکز، قضاوت، دقت و در نهایت روایتی را که جامعه دریافت می‌کند شکل می‌دهد.

### 10. آینده رسانه‌ها فقط به فناوری وابسته نیست، بلکه به کیفیت رابطه انسان، فناوری و جریان اطلاعات وابسته است.

فناوری به‌تنهایی آینده روزنامه‌نگاری را تعیین نمی‌کند؛ کیفیت این رابطه است که سرنوشت تحریریه‌ها را می‌سازد.
...
این منشور تلاشی است برای آغاز یک گفت‌وگوی جدی میان خبرنگاران، دبیران، عکاسان خبری، تهیه‌کنندگان، انجمن‌های صنفی، پژوهشگران، طراحان محصول، توسعه‌دهندگان و فعالان رسانه‌ای؛ گفت‌وگویی درباره آینده‌ای که در آن «تجربه روزنامه‌نگار» به اندازه خود خبر اهمیت داشته باشد.
...
**تجربه بهتر برای روزنامه‌نگار،**  
**آینده بهتر برای روزنامه‌نگاری.**  
